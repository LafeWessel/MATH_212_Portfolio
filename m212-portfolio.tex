...
When $n$ is even, we know that $(-1)^n = 1$.
\begin{align}
f(x) = y = \frac{1+(1)(2x-1)}{4}\\
y = \frac{1+(1)(2x-1)}{4}\\
4y = 1+(1)(2x-1)\\
4y-1 = (1)(2x-1)\\
4y-1 = 2x-1\\
...
2y=x
\end{align}
Thus, since the function $2y=x$ is linear, having all possible values of $x$ and $y$ as its domain and codomain, $f(n)$ is surjective when $n$ is even.

When $n$ is odd, we know that $(-1)^n=-1$.
\begin{align}
f(x) = y = \frac{1+(-1)(2x-1)}{4}\\
y = \frac{1+(-1)(2x-1)}{4}\\
4y = 1+(-1)(2x-1)\\
...
-2y+1=x
\end{align}
Thus, since the function $-2y+1=x$ is linear, having all possible values of $x$ and $y$ as its domain and codomain, $f(n)$ is surjective when $n$ is odd.
